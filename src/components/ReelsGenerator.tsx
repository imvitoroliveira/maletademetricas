...
import { ReelsChannels } from "@/components/reels/ReelsChannels";
    ...
    <div className="grid gap-6 lg:grid-cols-2">
      <Card className="border-none shadow-sm">
        <CardHeader>
          ...
          <CardDescription>Gere um roteiro avulso a partir de um tema ou link.</CardDescription>
        </CardHeader>
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500">
            Roteiros automáticos a partir dos canais que viralizam no seu nicho.
          </p>
        </div>
      </div>
      ...
      <Tabs defaultValue="feed" className="w-full">
        <TabsList>
          <TabsTrigger value="feed">Roteiros</TabsTrigger>
